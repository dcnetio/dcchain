...
use kitchensink_runtime::{
	...
	TechnicalCommitteeConfig, DcNodeConfig,
};
...
pub fn testnet_genesis(
	...
	let storage_call_account :AccountId = hex_literal::hex!("c1936b2f0709621a9f53f11064b5026cc9aa6c109f8057700bd60043d6bc63d6").into();
	let storage_stash :AccountId = hex_literal::hex!("1c190c4c953dc789468d67211819a2a05bcd1581b7e0b2bf36c03d29f4f47c38").into();
	let storage_controller :AccountId = hex_literal::hex!("72e1b32b28147178f22f1773bd4b54bc71829e67472f0154c6e0462b33956e55").into();
	...
	let mut endowed_accounts: Vec<AccountId> = endowed_accounts.unwrap_or_else(|| {
		vec![
			...
			storage_call_account.clone(),
			storage_stash.clone(),
			storage_controller.clone(),
		]
	});

	let other_stakers: Vec<(AccountId, AccountId)> = 
		vec![
			(storage_stash.clone(), storage_controller.clone()),
		];
	...
	let stakers = initial_authorities
		...
		.chain(other_stakers.iter().map(|x| (x.0.clone(), x.1.clone(), STASH, StakerStatus::Idle)))
		.collect::<Vec<_>>();
	...
	GenesisConfig {
		...
		dc_node: DcNodeConfig {
			...
			tee_report_verify_number: 0u32.into(),
			dev_config: vec![(storage_controller, storage_stash, storage_call_account, ("12D3KooWNr1ERkUSdUQjGtmtWPB8AtWGVuDVhcoZSH4UkudU2in9".as_bytes().to_vec()))]
		},
	}
}
